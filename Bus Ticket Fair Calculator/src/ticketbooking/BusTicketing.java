...
public class BusTicketing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxDestination.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Destination ", "Dhaka", "Pabna", "Jaipur", "Indore", "Dehra Dun", " " }));
    ...
    private void jButtonTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTotalActionPerformed
       ...
       if(jComboBoxDestination.getSelectedItem().equals("Dhaka") && jRadioButtonFirstClass1.isSelected()&& 
       ...
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Rajshahi");
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("Dhaka") && jRadioButtonEconomy1.isSelected()&& 
                jRadioButtonSingle1.isSelected() && (!(jTextFieldPassenger1.getText()== null) )){
          int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
       ...
       jTextFieldTicketType.setText(null);
        ...
        else if(jComboBoxDestination.getSelectedItem().equals("Dhaka") && jRadioButtonFirstClass1.isSelected()&& 
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Pabna")&& jRadioButtonEconomy1.isSelected()&& 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) )){
     int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
     
      jTextFieldPassengers2.setText(jTextFieldPassenger1.getText());
         jTextFieldTo.setText("Pabna");
       jTextFieldClass.setText("Economy");
       jTextFieldTicketType.setText("One Way");       
       jTextFieldDate2.setText(jDateChooser.getDate().toString());
         jTextFieldForm.setText("Rajshahi");
       ...
       else if(jComboBoxDestination.getSelectedItem().equals("Pabna") && jRadioButtonFirstClass1.isSelected() && 
               jRadioButtonSingle1.isSelected()&& (!(jTextFieldPassenger1.getText()== null) ) ){
           int Pass = Integer.parseInt(jTextFieldPassenger1.getText());
